...
public class DataHandler {
    ...
    /**
     * Default constructor Creates a new DataHandler with the default filename and
     * auto-save setting
     **/
    public DataHandler() throws IOException {
        // Call the other constructor using the default file name.
        // The default file is stored in the user's home directory.
        this(System.getProperty("user.dir") + System.getProperty("file.separator") + DEFAULT_FILE_NAME);
    }

    /**
     * Creates a new data handler with the specified filename. Uses the default
     * auto-save setting.
     **/
    ...
    /**
     * Creates a new data handler with the specified filename and auto-save setting
     **/
    public DataHandler(String fileName, boolean autoSave) throws IOException {
        ...
        try {
            ...
            throw new IOException("Invalid parser configuration." + separator + pce.getMessage());
        }
        ...
        try {
            ...
            throw new IOException("Unable to read document." + separator + se.getMessage());
        }
     ...
     * 
     * @return A list of all of the CalDays between firstDate (inclusive) and
     *         lastDate (exclusive) with their respective appointments. If the data
     *         handler has not been initialized correctly, null is returned.
     * @throws DateOutOfRangeException If any of the days constructed by the given
     *                                 values are invalid, or if date 2 is not after
     *                                 date 1.
     **/
    public List<CalDay> getApptRange(GregorianCalendar firstDay, GregorianCalendar lastDay)
        ...
        for (int i = 0; i < appts.getLength(); i++) {
            ...
            if (diagnose) {
                System.out.println("Nodes under the root: " + currentAppt.getTagName());
            }
            ...
            Appt appt = new Appt(Integer.parseInt((String) fields.get("startHour")),
                    ...
                    Integer.parseInt((String) fields.get("startYear")), (String) fields.get("title"),
                    (String) fields.get("description"), (String) fields.get("location"));
            LinkedList<String> recurDaysList = new LinkedList<String>();
            StringTokenizer stk = new StringTokenizer((String) fields.get("recurDays"));
            ...
            appt.setRecurrence(recurDaysArr, Integer.parseInt((String) fields.get("recurBy")),
    ...
    private static LinkedList<GregorianCalendar> getApptOccurences(Appt appt, GregorianCalendar firstDay,
        ...
        GregorianCalendar occurrenceDay = new GregorianCalendar(appt.getStartYear(), appt.getStartMonth() - 1,
                appt.getStartDay());
     ...
     * appointment does not recur it returns null. If the date cannot be calculated
    ...
    /**
     * Saves an appointment's information to the XML data tree. Does not write a new
     * XML file to disk.
     * 
    ...
    public boolean saveAppt(Appt appt) {
         ...
         * Unfortunately, this is a little sloppy because the work needs to be done
         * someplace. I am explaining one of the entries. The others are similar.
         **/
        ...
        Text startHourText = doc.createTextNode(Integer.toString(appt.getStartHour()));
        ...
        Text startMinuteText = doc.createTextNode(Integer.toString(appt.getStartMinute()));
        ...
        Text startDayText = doc.createTextNode(Integer.toString(appt.getStartDay()));
        ...
        Text startMonthText = doc.createTextNode(Integer.toString(appt.getStartMonth()));
        ...
        Text startYearText = doc.createTextNode(Integer.toString(appt.getStartYear()));
        ...
        Text recurByText = doc.createTextNode(Integer.toString(appt.getRecurBy()));
        ...
        Text recurIncrementText = doc.createTextNode(Integer.toString(appt.getRecurIncrement()));
        ...
        Text recurNumberText = doc.createTextNode(Integer.toString(appt.getRecurNumber()));
    ...
    /**
     * Deletes the appointment's information from the XML data tree. Does not write
     * a new XML file to disk.
     * 
